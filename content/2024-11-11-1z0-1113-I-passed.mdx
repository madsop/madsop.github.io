...
<Image src="/images/passed-exam.png" className="next-image" width="719" height="262" />
...
<Image src="/images/helidon-certified.png" className="next-image" width="1150" height="575" />
